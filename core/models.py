...
class AbstractBase(models.Model):
    updated_date = models.DateTimeField(auto_now=True, blank=True, verbose_name='Updated Date',
                                        help_text='Date when the record was last updated')
    created_date = models.DateTimeField(auto_now_add=True, blank=True, verbose_name='Created Date',
                                        help_text='Date when the record was created')
...
class GeneralSetting(AbstractBase):
    name = models.CharField(default='', max_length=254, blank=True, verbose_name='Setting Name',
...
class Skill(AbstractBase):
    ...
    name = models.CharField(default='', max_length=254, blank=True, verbose_name='Skill Name',
                            help_text='Name of the skill')
    percentage = models.PositiveIntegerField(default=50, verbose_name='Percentage',
                                             validators=[MinValueValidator(0), MaxValueValidator(100)],
                                             help_text='Percentage of the skill')
...
class Experience(AbstractBase):
    company = models.CharField(default='', max_length=254, blank=True, verbose_name='Company',
                               help_text='Name of the company')
    job_title = models.CharField(default='', max_length=254, blank=True, verbose_name='Job Title',
                                 help_text='Job title in the company')
    position = models.CharField(default='', max_length=254, blank=True, verbose_name='Position',
                                help_text='Position in the company')
    location = models.CharField(default='', max_length=254, blank=True, verbose_name='Location',
                                help_text='Location of the company')
...
class Education(AbstractBase):
    school_name = models.CharField(default='', max_length=254, blank=True, verbose_name='School Name',
                                   help_text='Name of the school')
    major = models.CharField(default='', max_length=254, blank=True, verbose_name='Major',
                             help_text='Major in the school')
    department = models.CharField(default='', max_length=254, blank=True, verbose_name='Department',
                                  help_text='Department in the school')
    location = models.CharField(default='', max_length=254, blank=True, verbose_name='Location',
                                help_text='Location of the school')
...
class Documents(AbstractBase):
    order = models.PositiveIntegerField(default=0, verbose_name='Order', help_text='Order of the document')
    slug = models.SlugField(default='', max_length=254, blank=True, verbose_name='Slug',)
    file = models.FileField(upload_to='documents/', blank=True, verbose_name='File', help_text='')
